  ...
  return (
    <>
     <div className="container" style={{color: props.mode === 'dark'?'white':'black'}}>
         ...
         <button className="btn btn-info mx-1 my-1" onClick={handleUpClick}> UpperCase</button>
         <button className="btn btn-info mx-1 my-1" onClick={handleLoClick}> LowerCase</button>
         <button className="btn btn-info mx-1 my-1" onClick={handleSeClick}> SentenceCase</button>
         <button className="btn btn-info mx-1 my-1" onClick={handleCaClick}> CapitalizedCase</button>
         <button className="btn btn-info mx-1 my-1" onClick={handleAtClick}> aTyicalCase</button>
